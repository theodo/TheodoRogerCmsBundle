...
class LayoutControllerTest extends WebTestCase
{
    ...
    public function testNew()
    {
        ...
        $crawler = $client->request('GET', '/admin/fr/layouts/new', array(), array(), array(
            'PHP_AUTH_USER' => 'admin',
            'PHP_AUTH_PW'   => 'admin'
        ));
    ...
    public function testEdit()
    {
        ...
        $crawler = $client->request('GET', '/admin/fr/layouts/1/edit', array(), array(), array(
            'PHP_AUTH_USER' => 'admin',
            'PHP_AUTH_PW'   => 'admin'
        ));
    ...
    public function testUpdate()
    {
        ...
        $crawler = $client->request('GET', '/admin/fr/layouts/1', array(), array(), array(
            'PHP_AUTH_USER' => 'admin',
            'PHP_AUTH_PW'   => 'admin'
        ));
    ...
    public function testRemove()
    {
        ...
        $crawler = $client->request('GET', '/admin/fr/layouts/1/remove', array(), array(), array(
            'PHP_AUTH_USER' => 'admin',
            'PHP_AUTH_PW'   => 'admin'
        ));
    ...
    public function testWorkflow()
    {
        ...
        // Test return
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
        $this->assertRegexp('/.*admin\/fr\/layouts\/new$/', $client->getRequest()->getUri());
        $this->assertRegexp('/.*New Layout.*/', $client->getResponse()->getContent());
        ...
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
        $this->assertRegexp('/.*admin\/fr\/layouts\/.*\/edit$/', $client->getRequest()->getUri());
        $this->assertRegexp('/.*Edit.*/', $client->getResponse()->getContent());
        ...
        $this->assertEquals(302, $client->getResponse()->getStatusCode());
        $crawler = $client->followRedirect();
        $this->assertRegexp('/.*admin\/fr\/layouts$/', $client->getRequest()->getUri());
    }
}
