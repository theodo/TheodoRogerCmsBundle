...
use Theodo\TheodoCmsBundle\DataFixtures\ORM\PageData;
...
class PageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetParent()
    {
        ...
        // Retrieve "about" page
        $aboutPage = $em->getRepository('TheodoTheodoCmsBundle:Page')->findOneBy(array('slug' => 'about'));

        // Test aboutPage
        $this->assertInstanceOf('Theodo\TheodoCmsBundle\Entity\Page', $aboutPage);
        $this->assertEquals('About', $aboutPage->getName());
        
        // Retrieve parent page
        $parentPage = $aboutPage->getParent();
        $this->assertInstanceOf('Theodo\TheodoCmsBundle\Entity\Page', $parentPage);
    ...
    public function testGetChildren()
    {
        ...
        // Retrieve "about" page
        $homepage = $em->getRepository('TheodoTheodoCmsBundle:Page')->findOneBy(array('slug' => 'homepage'));

        // Test hompepage
        $this->assertInstanceOf('Theodo\TheodoCmsBundle\Entity\Page', $homepage);
